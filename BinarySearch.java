...
public class BinarySearch {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(correctPossiblitiesCount(4, 1, 2));
    }
    ...
    private static int correctPossiblitiesCount(int N, int x, int pos) {
        ...
        while (start < end) {
            ...
            if (middle <= pos) {
                start = middle + 1;
                possibilityCount = possibilityCount * prevCount;
                prevCount--;
            } else {
                end = middle;
                possibilityCount = possibilityCount * postCount;
                postCount--;
            }
        }
